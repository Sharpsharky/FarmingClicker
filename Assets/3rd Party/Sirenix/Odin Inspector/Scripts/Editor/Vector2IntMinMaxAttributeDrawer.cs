...
namespace _3rd_Party.Sirenix.Odin_Inspector.Scripts.Editor
{
    ...
    using global::Sirenix.OdinInspector.Editor.ValueResolvers;
    ...
    /// </summary>
    public class
        Vector2IntMinMaxAttributeDrawer : OdinAttributeDrawer<MinMaxSliderAttribute, Vector2Int>
    {
        ...
        protected override void Initialize()
        {
            ...
            if(Attribute.MinMaxValueGetter != null)
            {
                vector2IntMinMaxGetter =
                    ValueResolver.Get<Vector2Int>(Property, Attribute.MinMaxValueGetter);
            }
        }
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            var value =
                SirenixEditorFields.MinMaxSlider(label, ValueEntry.SmartValue, range,
