...
namespace _3rd_Party.Sirenix.Odin_Inspector.Scripts.Editor
{
    ...
    public sealed class Vector2IntResolver : BaseMemberPropertyResolver<Vector2Int>
    {
        protected override InspectorPropertyInfo[] GetPropertyInfos()
        {
            return new[]
                   {
                       InspectorPropertyInfo.CreateValue("x", 0,
                                                         Property.ValueEntry.SerializationBackend,
                                                         new GetterSetter<Vector2Int, int>(
                                                          (ref Vector2Int vec) => vec.x,
                                                          (ref Vector2Int vec, int value) =>
                                                              vec.x = value)),
                       InspectorPropertyInfo.CreateValue("y", 0,
                                                         Property.ValueEntry.SerializationBackend,
                                                         new GetterSetter<Vector2Int, int>(
            ...
            return new[]
                   {
                       ...
                       InspectorPropertyInfo.CreateValue("y", 0,
                                                         ...
                                                         new GetterSetter<Vector3Int, int>(
                                                          ...
                                                          (ref Vector3Int vec, int value) =>
                                                              vec.y = value)),
                       InspectorPropertyInfo.CreateValue("z", 0,
                                                         Property.ValueEntry.SerializationBackend,
                                                         new GetterSetter<Vector3Int, int>(
