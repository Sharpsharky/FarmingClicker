...
/*
 * This class let you use a CultureInfo as a field that will apear in the inspector.
 * 
 */ 
namespace InfiniteValue
{
    [Serializable] public class Culture : ISerializationCallbackReceiver
    {
        ...
        /// <summary>Use this property to get a CultureInfo from this instance.</summary>
