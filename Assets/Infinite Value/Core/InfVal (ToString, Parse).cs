...
{
    [Flags] public enum DisplayOption : byte
    {
        None = 0,
    ...
    public partial struct InfVal : IFormattable
    {
        ...
        /// <summary>Returns a string detailing the digits and exponent of this InfVal, useful for debugging purposes.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        ...
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This will throw an exception if the string isn't a valid number.</summary>
        public static InfVal Parse(string s, string[] unitsList, IFormatProvider provider)
        {
            InfVal ret = new InfVal();
            ret.SetValueFromString(s, unitsList, ProviderToFormatParams(provider), true);
            return ret;
        }
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This will throw an exception if the string isn't a valid number.</summary>
        public static InfVal Parse(string s, string[] unitsList) => Parse(s, unitsList, null);
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This will throw an exception if the string isn't a valid number.</summary>
        public static InfVal Parse(string s, IFormatProvider provider) => Parse(s, Configuration.unitsList, provider);
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This will throw an exception if the string isn't a valid number.</summary>
        public static InfVal Parse(string s) => Parse(s, Configuration.unitsList, null);

        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception but the returned bool indicates whether the operation succeeded.</summary>
        public static bool TryParse(string s, string[] unitsList, IFormatProvider provider, out InfVal result)
        {
            result = new InfVal();
            try { result.SetValueFromString(s, unitsList, ProviderToFormatParams(provider), true); }
            catch { return false; }
            return true;
        }
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception but the returned bool indicates whether the operation succeeded.</summary>
        public static bool TryParse(string s, string[] unitsList, out InfVal result) => TryParse(s, unitsList, null, out result);
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception but the returned bool indicates whether the operation succeeded.</summary>
        public static bool TryParse(string s, IFormatProvider provider, out InfVal result) => TryParse(s, Configuration.unitsList, provider, out result);
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception but the returned bool indicates whether the operation succeeded.</summary>
        public static bool TryParse(string s, out InfVal result) => TryParse(s, Configuration.unitsList, null, out result);

        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception, if the string isn't a valid number the method will do it's best to return a valid InfVal.</summary>
        public static InfVal ParseOrDefault(string s, string[] unitsList, IFormatProvider provider)
        {
            InfVal ret = new InfVal();
            ret.SetValueFromString(s, unitsList, ProviderToFormatParams(provider), false);
            return ret;
        }
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception, if the string isn't a valid number the method will do it's best to return a valid InfVal.</summary>
        public static InfVal ParseOrDefault(string s, string[] unitsList) => ParseOrDefault(s, unitsList, null);
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception, if the string isn't a valid number the method will do it's best to return a valid InfVal.</summary>
        public static InfVal ParseOrDefault(string s, IFormatProvider provider) => ParseOrDefault(s, Configuration.unitsList, provider);
        /// <summary>Converts the string representation of a number to its InfVal equivalent. 
        /// This won't throw an exception, if the string isn't a valid number the method will do it's best to return a valid InfVal.</summary>
        public static InfVal ParseOrDefault(string s) => ParseOrDefault(s, Configuration.unitsList, null);
