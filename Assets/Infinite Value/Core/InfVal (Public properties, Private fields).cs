    ...
    public partial struct InfVal
    {
        ...
        public int exponent
        {
            ...
            private set
            {
                ...
                if (-(s_exponent - value) >= precision)
                    digits = 0;
                else
                    digits = MultiplyBigIntByPowOf10(digits, s_exponent - value);

                s_exponent = value;
            }
        }

        /// <summary>Count of digits of this InfVal.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        public int precision => (isZero && exponent <= 0 ? -exponent + 1 : cacheDigitsToString.Length - (sign < 0 ? 1 : 0));

        /// <summary>Is this InfVal an integer value. Can be true with a negative exponent if every digits after the decimal point are 0.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        public bool isInteger => (exponent >= 0 || cacheDigitsToString.EndsWith(new string('0', -exponent)));

        /// <summary>Is this InfVal equal to 0.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        public bool isZero => digits.IsZero;

        /// <summary>Is this InfVal equal to 1.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        public bool isOne
        ...
        /// <summary>Is this InfVal an even number. Will throw an exception if exponent is negative.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        public bool isEven
        ...
        /// <summary>Is this InfVal 2 to an integer power.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        ...
        /// <summary>The sign of this InfVal: 1, 0 or -1.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
