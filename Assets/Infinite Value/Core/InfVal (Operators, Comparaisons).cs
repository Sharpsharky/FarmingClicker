...
namespace InfiniteValue
{
    public partial struct InfVal : IComparable, IComparable<InfVal>, IEquatable<InfVal>
    {
        ...
        public static InfVal operator /(in InfVal a, in InfVal b)
        {
            ...
            return ManualFactory(MultiplyBigIntByPowOf10(a.digits, resPrecision) / b.digits, a.exponent - b.exponent - resPrecision).ToPrecision(resPrecision);
        }
        public static InfVal operator %(in InfVal a, in InfVal b)
        {
            if (b.isZero)
        ...
        /// <summary>Returns a value indicating whether this instance is equal to another object.</summary>
        ...
        /// <summary>Returns a value indicating whether this instance is equal to a specified InfVal.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
        public bool Equals(InfVal other) => (this == other);

        /// <summary>Compares this instance to a specified InfVal and returns an indication of their relative values.</summary>
#if UNITY_2020_2_OR_NEWER
        readonly
#endif
