...
{
    public static class GeneralEditorUtilities
    {
        [UnityEditor.Callbacks.DidReloadScripts]
        static void MoveGizmosFolder()
        {
    ...
    public static class ExtraEditorGUILayout
    {
        ...
        /// <summary>
        /// Draw a SerializedProperty of a string[] or List<string> field with a check before adding a value.
        /// </summary>
        ...
        /// <param name="foldedStr">Parameter that define how to draw the string used when the property is folded. elemFormat is a format applied 
        /// to every elements and separator is added in between them.</param>
    ...
    {
        /// <summary>
        /// This function return a string unique to a SerializedProperty, it is useful for making parameters fields related to one Property in an editor
        /// or property drawer without adding a useless out of editor usage field to the base class.
        /// </summary>
